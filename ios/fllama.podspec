...
Pod::Spec.new do |s|
  ...
  s.pod_target_xcconfig = {
    ...
    'OTHER_CFLAGS' => ['$(inherited)', '-O3', '-flto', '-fno-objc-arc', '-w',
                       '-I$(PODS_TARGET_SRCROOT)/../llama.cpp/include', '-I$(PODS_TARGET_SRCROOT)/../llama.cpp/ggml/include', '-I$(PODS_TARGET_SRCROOT)/../llama.cpp/common', '-DGGML_LLAMAFILE=OFF', '-DGGML_USE_CPU'],
    'OTHER_CPLUSPLUSFLAGS' => ['$(inherited)', '-O3', '-flto', '-fno-objc-arc', '-w', '-std=c++17', '-fpermissive',
                               '-I$(PODS_TARGET_SRCROOT)/../llama.cpp/include', '-I$(PODS_TARGET_SRCROOT)/../llama.cpp/ggml/include', '-I$(PODS_TARGET_SRCROOT)/../llama.cpp/common', '-DGGML_LLAMAFILE=OFF', '-DGGML_USE_CPU'],
